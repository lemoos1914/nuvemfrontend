...
async function fetchProducts() {
  const response = await fetch('http://3.238.227.172:3000/products');
...
async function deleteProduct(id) {
  try {
    const response = await fetch('http://3.238.227.172:3000/products/' + encodeURIComponent(id), {
      method: 'DELETE',
      headers: {
        'Content-Type': 'application/json'
      },
...
async function updateProduct(id, name, price, description) {
  ...
  try {
    ...
    let res = await fetch('http://3.238.227.172:3000/products/' + encodeURIComponent(id), {
      method: 'PATCH',
    ...
    if (res.status === 405) {
      ...
      res = await fetch('http://3.238.227.172:3000/products/' + encodeURIComponent(id), {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify(payload)
      });
